...
def obj_ss(x,model,do_print=False):
    ...
    # e. market clearing
    #ss.B = 0.0             *** Den her skal vel bare slettes 
    ss.L = ss.L_hh # L_ss    *** Clearing_L clearer mekanisk  -  Ud fra det her clearer markederne rent mekanisk, er clearing_L overflødig, er den her overflødig? Eller beregner vi den her for at bruge og så det bare pænt at have begge steder
    ss.L_Y = ss.L - ss.L_G
    ss.K = KL*ss.L_Y
